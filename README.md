...
```bash
cargo install --git https://github.com/kei-prog/shikigami --tag v0.3.0
```
...
not copied. During the first response, it starts an empty side chat because there
is no completed turn to copy yet.
